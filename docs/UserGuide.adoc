...
* Some commands have alias that can be used instead of the full command e.g `add` can be replace with just `a` or `edit` with `e`.
...
* `a n/Mac Donald p/1234567 e/macdelivery@kfc.com a/Trump street`
...
* `e 3 p/12345670` +
Edits the phone number of the 3rd person to be `12345670`.
